...
configure_page("Scout Scanner v7 | NABI Scout", "🧠")
render_sidebar()

st.title("🧠 Scout Scanner v7")
st.caption(
    "Decision, Explain ve Confidence Engine ile gerekçeli araştırma kararı üretir."
)
...
if st.button("Sprint 7 taramasını başlat", type="primary"):
    engine = ScannerV7Engine(
    ...
    for index, row in enumerate(selected_rows, 1):
        ...
        output.append({
            ...
            "Not": candidate.get("investment_grade"),
            "Karar": candidate.get("decision_label"),
            "Eylem": candidate.get("decision_action"),
    ...
    st.success(
        f"Sprint 7 taraması tamamlandı. "
        f"{updated} araştırma adayı kaydedildi, "
