...
PROFILE_REAL_ESTATE_PARTICIPATION_FUND = "REAL_ESTATE_PARTICIPATION_FUND"
PROFILE_MIXED_MULTI_ASSET_PARTICIPATION_FUND = "MIXED_MULTI_ASSET_PARTICIPATION_FUND"
...
# Real-estate participation. Defined from mandate economics before any
# real-estate fund score is observed. REAL_ESTATE_CONCENTRATION is the
# property-specific dimension; missing stays MISSING and is unweighted.
# No MOMENTUM: unit-price change would double-count PERFORMANCE.
...
# Mixed / multi-asset participation. Defined before any mixed-fund score.
# No MOMENTUM: would double-count PERFORMANCE. No MATURITY: not a WAM rule.
# Missing READY dimensions are excluded, never redistributed.
MIXED_MULTI_ASSET_PARTICIPATION_FUND_WEIGHTS = {
    DIM_PERFORMANCE_EVAL: 0.20,
    DIM_RISK_EVAL: 0.20,
    DIM_COST_EVAL: 0.15,
    DIM_DIVERSIFICATION_EVAL: 0.25,
    DIM_CONCENTRATION_EVAL: 0.20,
}
...
PROFILE_REAL_ESTATE_PARTICIPATION = "real_estate_participation"
PROFILE_MIXED_MULTI_ASSET_PARTICIPATION = "mixed_multi_asset_participation"
