...
SHADOW_BLOCKER_UNAVAILABLE = "PORTFOLIO_EXPOSURE_UNAVAILABLE"
...
# Hybrid-ON order. Live production remains LIVE_BLOCKER_INCOMPLETE while the flag is OFF.
HYBRID_BLOCKER_PRECEDENCE = (
    SHADOW_BLOCKER_UNAVAILABLE,
